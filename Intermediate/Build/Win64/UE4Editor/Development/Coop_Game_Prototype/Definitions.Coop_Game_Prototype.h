...
#define ORIGINAL_FILE_NAME "UE4Editor-Coop_Game_Prototype.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Coop_Game_Prototype
#define DEPRECATED_FORGAME DEPRECATED
#define COOP_GAME_PROTOTYPE_API DLLEXPORT
